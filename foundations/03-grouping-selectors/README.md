...
This will help you work with classes and class selectors, so be sure you add the class attribute in the HTML file. For the remainder of these exercises, the format of any colors is entirely up to you; use whichever values fit best. The properties you need to add to each element are:
